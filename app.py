...
def populate_env(sender_email, receiver_email, subject):
...
def send_email(sender_email, receiver_email, subject, thread_id):
    try:
        populate_env(sender_email, receiver_email, subject)
...
def render_ui():
    ...
    st.markdown('<div class="sub-title">Enter your travel query and get flight and hotel information:</div>',
                unsafe_allow_html=True)
