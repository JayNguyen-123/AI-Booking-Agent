...
class HotelsInput(BaseModel):
    ...
    check_in_date: str = Field(description='Check-in date. The format is YYYY-MM-DD. e.g. 2025-07-01')
    check_out_date: str = Field(description='Check-out date. The format is YYYY-MM-DD. e.g. 2025-07-01')
